...
export function useRobotCouncil(
    ...
    }, [activeSymbol, dailyBalance, timePeriod, toast, user, robotPerformance, baseDuration, baseDurationUnit]);
    ...
    useEffect(() => {
        ...
        user,
        baseDuration,
        isAuthLoading // Adicionado para garantir que o user esteja carregado
    ]);
